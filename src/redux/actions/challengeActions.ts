...
const challengeWithUserQuery = (orderBy: string, ascending: boolean) => supabase.from("challenge").select("*, user(*), challenge_like(*)").order(orderBy, { ascending }).returns<ChallengeWithUser[]>()
